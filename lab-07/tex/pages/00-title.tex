\begin{titlepage}
	...
	\begin{flushleft}
		...
		Студент \uline{\mbox{\hspace{44mm}} Ковель Александр Денисович, Солопов Юрий Витальевич \hfill}
	...
	\begin{table}[h!]
		...
		\end{signstabular}
		\begin{signstabular}[0.55]{p{7.25cm} >{\centering\arraybackslash}p{4cm} >{\centering\arraybackslash}p{4cm}}
			Студент & \uline{\mbox{\hspace*{4cm}}} & \uline{\hfill \textbf{Солопов Ю.В.} \hfill} \\
			& \scriptsize \textit{подпись, дата} & \scriptsize \textit{фамилия, и.о.}
		\end{signstabular}
		\vspace{\baselineskip}
